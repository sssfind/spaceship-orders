...
// List provides a mock function with given fields: ctx, userUUID
func (_m *MockOrderRepository) List(ctx context.Context, userUUID uuid.UUID) ([]*model.Order, error) {
...
//   - ctx context.Context
//   - userUUID uuid.UUID
func (_e *MockOrderRepository_Expecter) List(ctx interface{}, userUUID interface{}) *MockOrderRepository_List_Call {
	return &MockOrderRepository_List_Call{Call: _e.mock.On("List", ctx, userUUID)}
}

func (_c *MockOrderRepository_List_Call) Run(run func(ctx context.Context, userUUID uuid.UUID)) *MockOrderRepository_List_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockOrderRepository_List_Call) RunAndReturn(run func(context.Context, uuid.UUID) ([]*model.Order, error)) *MockOrderRepository_List_Call {
	_c.Call.Return(run)
	return _c
}
